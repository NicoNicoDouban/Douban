# -*- coding: utf-8 -*-
# Generated by Django 1.11.9 on 2018-03-26 11:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(default='user', max_length=20, null=True, verbose_name='用户名')),
                ('nick_name', models.CharField(default='小豆瓣儿', max_length=20, null=True, verbose_name='昵称')),
        ...
        migrations.AddField(
            ...
            name='toId',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='被关注者', to=settings.AUTH_USER_MODEL, verbose_name='被关注的人'),
        ),
        migrations.AddField(
            model_name='followlink',
            name='userId',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='关注者', to=settings.AUTH_USER_MODEL, verbose_name='发起关注的人'),
        ),
        migrations.AddField(
            model_name='comments',
            name='commenter_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='发表评论的人'),
        ),
        migrations.AddField(
            model_name='articles',
            name='writer',
